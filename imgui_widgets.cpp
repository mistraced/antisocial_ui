...
bool ImGui::InputTextEx( const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* callback_user_data )
{
    ...
    if ( !is_multiline )
    {
        ...
        window->DrawList->AddRect( frame_bb.Min, frame_bb.Max, ImColor( 55, 55, 66, static_cast< int >( GetStyle( ).Alpha * 255 ) ), 6 );
...
bool ImGui::ColorPicker4( const char* label, float col[ 4 ], ImGuiColorEditFlags flags, const float* ref_col )
{
    ...
    } else if ( flags & ImGuiColorEditFlags_PickerHueBar )
    {
        ...
        // Render Hue Bar
        for ( int i = 0; i < 6; ++i )
            draw_list->AddRectFilledMultiColor( ImVec2( bar0_pos_x, picker_pos.y + i * ( sv_picker_size / 6 ) ), ImVec2( bar0_pos_x + bars_width, picker_pos.y + ( i + 1 ) * ( sv_picker_size / 6 ) ), col_hues[ i ], col_hues[ i ], col_hues[ i + 1 ], col_hues[ i + 1 ], 5, i == 0 ? ImDrawFlags_RoundCornersTop : i == 5 ? ImDrawFlags_RoundCornersBottom
    ...
    draw_list->AddCircleFilled( ImVec2( bar0_pos_x + 7.f, state.hue_bar ), 4.5f, col_black, 100.f );
    ...
    if ( alpha_bar )
    {
        ...
        draw_list->AddCircleFilled( ImVec2( bar1_pos_x + 7.f, state.alpha_bar ), 4.5f, col_black, 100.f );
    }
